...
Descartamos todas aquellas encuestas que hagan referencia a elecciones anteriores a 2008, que sean a pie de urna, que tenga un tamaño muestral inferior a 750 o que sea desconocido que tengan menos de 1 o menos días de trabajo de campo.
...
## ¿Cuál el partido ganador en los municipios de más de 100 000 habitantes de censo en cada una de las elecciones? {#pregunta2}
...
Finalmente, obentemos el resultado.
...
Lo primero que hay que hacer es crear una variable que indique a que elección se refiere cada encuesta.
...
Calculamos la media y de los errores por elecciones
...
graf <- encuestas_error |> 
  ...
  labs(title = "Error cometido en cada partido por las encuestadoras",
       ...
       y = "Error cometido",
       caption = "A. Moreno-Ribera \n P. Villoslada-Blanco") +
  theme_update(plot.title = element_text(size = 15, face = "bold", family = "Montserrat"),
